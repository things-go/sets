...
func TestInt8Set(t *testing.T) {
	...
	// improve cover
	s2 = NewInt8From(map[int8]interface{}{1: "1", 2: "2", 3: "3"})
	s2.UnsortedList()
}

func TestInt8SetDeleteMultiples(t *testing.T) {
	s := Int8{}
	s.Insert(1, 2, 3)
	if len(s) != 3 {
...
func TestInt8SetList(t *testing.T) {
	s := NewInt8(13, 12, 11, 1)
	if !reflect.DeepEqual(s.List(), []int8{1, 11, 12, 13}) {
...
func TestInt8SetHasAny(t *testing.T) {
	a := NewInt8(1, 2, 3)
...
func TestInt8Union(t *testing.T) {
	tests := []struct {
		s1       Int8
		s2       Int8
		expected Int8
...
func TestInt8Intersection(t *testing.T) {
	tests := []struct {
		s1       Int8
		s2       Int8
		expected Int8
...
func TestInt8Merge(t *testing.T) {
	tests := []struct {
		s1       Int8
		s2       Int8
		expected Int8
