...
func TestUintSet(t *testing.T) {
	...
	// improve cover
	s2 = NewUintFrom(map[uint]interface{}{1: "1", 2: "2", 3: "3"})
	s2.UnsortedList()
}

func TestUintSetDeleteMultiples(t *testing.T) {
	s := Uint{}
	s.Insert(1, 2, 3)
	if len(s) != 3 {
...
func TestUintSetList(t *testing.T) {
	s := NewUint(13, 12, 11, 1)
	if !reflect.DeepEqual(s.List(), []uint{1, 11, 12, 13}) {
...
func TestUintSetHasAny(t *testing.T) {
	a := NewUint(1, 2, 3)
...
func TestUintUnion(t *testing.T) {
	tests := []struct {
		s1       Uint
		s2       Uint
		expected Uint
...
func TestUintIntersection(t *testing.T) {
	tests := []struct {
		s1       Uint
		s2       Uint
		expected Uint
...
func TestUintMerge(t *testing.T) {
	tests := []struct {
		s1       Uint
		s2       Uint
		expected Uint
